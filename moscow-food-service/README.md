...
## Выводы
Мною было проведено анализ рынка общепита и, в частности, кофеен. По результатам исследования подготовил презентацию для инвесторов с рекомендациями по открытию кофейни.
...
2. Разбить город на гексагоны с помощью библиотеки `H3/Uber`;
